...
set(_exported_dependencies "ament_cmake;ament_cmake_python;mpi_cmake_modules;mim_msgs;ament_index_cpp;dynamic_graph_manager;yaml_utils;real_time_tools;lcm;Eigen3;dynamic-graph;dynamic-graph-python")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to dgm_fr3_dyn_DEFINITIONS, dgm_fr3_dyn_INCLUDE_DIRS,
# dgm_fr3_dyn_LIBRARIES, and dgm_fr3_dyn_LINK_FLAGS.
# Additionally collect the direct dependency names in
# dgm_fr3_dyn_DEPENDENCIES as well as the recursive dependency names
# in dgm_fr3_dyn_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(dgm_fr3_dyn_DEPENDENCIES ${_exported_dependencies})
  set(dgm_fr3_dyn_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(dgm_fr3_dyn_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(dgm_fr3_dyn_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(dgm_fr3_dyn_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(dgm_fr3_dyn_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(dgm_fr3_dyn_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND dgm_fr3_dyn_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
