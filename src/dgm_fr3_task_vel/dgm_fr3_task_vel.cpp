...
{
  desired_velocities_ = map.at("ctrl_task_vel");
...
void DGMFrankaKin::compute_safety_controls()
{
  ...
  for (VectorDGMap::iterator ctrl = motor_controls_map_.begin(); ctrl != motor_controls_map_.end(); ++ctrl)
  {
